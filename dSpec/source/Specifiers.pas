...
type
  ...
  public
    constructor Create(ACallerAddress : Pointer; AContext : IContext; const AValueName : string; Negated : Boolean = False); reintroduce;
  ...
  private
    FActual: Integer;
  public
    constructor Create(Actual: Integer; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
  ...
  private
    FActual: Boolean;
  public
    constructor Create(Actual: Boolean; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
    function Equal(Expected : Variant) : IModifier; override;
  ...
  public
    constructor Create(Actual: Extended; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
    function Equal(Expected : Variant) : IModifier; override;
    function GreaterThan(Expected : Variant) : IModifier; override;
    function LessThan(Expected : Variant) : IModifier; override;
    function AtLeast(Expected : Variant) : IModifier; override;
  ...
  protected
    function CreateModifier(RemoveLastFailure: Boolean; FailureMessage: string) : IModifier; override;
  public
    constructor Create(Actual: string; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
    function Equal(Expected : Variant) : IModifier; override;
  ...
  private
    FActual: TObject;
  public
    constructor Create(Actual: TObject; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
  ...
  private
    FActual: Pointer;
  public
    constructor Create(Actual, ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
    function Nil_ : IModifier; override;
    function Assigned : IModifier; override;
  end;
  ...
  private
    FActual: TClass;
  public
    constructor Create(Actual: TClass; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
  ...
  private
    FActual: TDateTime;
  public
    constructor Create(Actual: TDateTime; ACallerAddress: Pointer; AContext: IContext; const AValueName : string); reintroduce;
    function Equal(Expected : Variant) : IModifier; override;
    function LessThan(Expected : Variant) : IModifier; override;
    function GreaterThan(Expected : Variant) : IModifier; override;
    function AtLeast(Expected : Variant) : IModifier; override;
  ...
  private
    FActual: IInterface;
  public
    constructor Create(Actual : IInterface; ACallerAddress : Pointer; AContext : IContext; const AValueName : string); reintroduce;
    destructor Destroy; override;
    function Support(Expected : TGUID) : IModifier; override;
    function Assigned : IModifier; override;
    function Nil_ : IModifier; override;
...
constructor TBaseSpecifier.Create(ACallerAddress: Pointer; AContext: IContext;
  const AValueName : string; Negated: Boolean);
begin
...
constructor TIntegerSpecifier.Create(Actual: Integer; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
...
constructor TBooleanSpecifier.Create(Actual: Boolean; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TFloatSpecifier.Create(Actual: Extended; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TStringSpecifier.Create(Actual: string; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TObjectSpecifier.Create(Actual: TObject; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TPointerSpecifier.Create(Actual, ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TClassSpecifier.Create(Actual: TClass; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TDateTimeSpecifier.Create(Actual: TDateTime; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
...
constructor TInterfaceSpecifier.Create(Actual: IInterface; ACallerAddress: Pointer;
  AContext: IContext; const AValueName : string);
begin
  inherited Create(ACallerAddress, AContext, AValueName);
  FActual := Actual;
